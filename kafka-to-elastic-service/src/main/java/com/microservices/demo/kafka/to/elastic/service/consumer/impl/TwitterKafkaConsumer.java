...
public class TwitterKafkaConsumer implements KafkaConsumer<Long, TwitterAvroModel> {
    ...
    public TwitterKafkaConsumer(KafkaListenerEndpointRegistry kafkaListenerEndpointRegistry,
                                ...
                                KafkaConfigData kafkaConfigData, AvroToElasticModelTransformer avroToElasticModelTransformer, ElasticIndexClient<TwitterIndexModel> elasticIndexClient, KafkaConsumerConfigData kafkaConsumerConfigData){
    ...
    public void onAppStarted(ApplicationStartedEvent event){
        ...
        LOG.info("Topics with names {} is ready for Operations!",
