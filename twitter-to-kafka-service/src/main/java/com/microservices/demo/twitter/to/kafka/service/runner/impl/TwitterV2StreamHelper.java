...
public class TwitterV2StreamHelper {
        ...
        if (null != entity) {
            ...
            while (line != null) {
                ...
                if(!line.isEmpty()){
                    ...
                    if(status != null){
                        twitterKafkaStatusListner.onStatus(status);
                    }
                }
            }
        }
    ...
    private String getFormattedTweet(String line) {
        System.out.println("LINE: "+line);
        System.out.println("TOKEN: "+System.getProperty("TWITTER_BEARER_TOKEN"));
        JSONObject jsonObject = (JSONObject) new JSONObject(line).get("data");
    ...
    public void setupRules(String bearerToken, Map<String, String> rules) throws IOException, URISyntaxException {
        ...
        if (existingRules.size() > 0) {
            LOG.info("Existing Rules exists : {}",existingRules);
