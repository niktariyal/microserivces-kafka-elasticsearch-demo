...
public class TwitterV2KafkaStreamRunner implements StreamRunner {
    ...
    @Override
    public void start()  {
        String bearerToken = "AAAAAAAAAAAAAAAAAAAAAKpQgAEAAAAAfdmhiJwy4x0UYp7AQdhgwWnpnsA%3DlHKXtnplFsLV6AUKb6zaFkBAniKCVnh7dUNB82ENuOFytboauQ";
                //twitterToKafkaServiceConfigData.getTwitterV2BearerToken();
        if(null != bearerToken){
            try {
    ...
    private Map<String, String> getRules(){
        ...
        LOG.info("Create filter for twitter stream for keywords: {}",keywords);
        return rules;
    }
}
