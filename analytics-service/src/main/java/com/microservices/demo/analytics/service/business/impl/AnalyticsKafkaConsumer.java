...
public class AnalyticsKafkaConsumer implements KafkaConsumer<TwitterAnalyticsAvroModel> {
    ...
    public static final Logger LOG = LoggerFactory.getLogger(AnalyticsKafkaConsumer.class);
    ...
    public void receive(@Payload List<TwitterAnalyticsAvroModel> messages,
        ...
        List<AnalyticsEntity> twitterAnalyticsEntities =
                avroToDbEntityModelTransformer.getEntityModel(messages);
