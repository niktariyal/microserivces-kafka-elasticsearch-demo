...
public class KafkaAdminClient {
    ...
    public void createTopics(){
        ...
        LOG.info("KafkaAdminClient | createTopics | method init");
        try{
    ...
    public void checkTopicsCreated(){
        ...
        LOG.info("KafkaAdminClient | checkTopicsCreated | topics: {}", topics.toArray());
        int retryCount = 1;
    ...
    public void checkSchemaRegistry(){
        LOG.info("KafkaAdminClient | checkSchemaRegistry | method init");
        int retryCount = 1;
        Integer maxRetry = retryConfigData.getMaxAttempts();
        Integer multiplier = retryConfigData.getMultiplier().intValue();
        Long sleepTimeMs = retryConfigData.getSleepTimeMs();
    ...
    private Collection<TopicListing> getTopics(){
        LOG.info("KafkaAdminClient | getTopics | method init");
        Collection<TopicListing> topics;
        try{
            topics = retryTemplate.execute(this::doGetTopics);
            LOG.info("KafkaAdminClient | getTopics | topics: {}", topics.toArray());
        }catch (Throwable t){
    ...
    private Collection<TopicListing> doGetTopics(RetryContext retryContext) throws ExecutionException, InterruptedException {
        ...
        LOG.info("KafkaAdminClient | doGetTopics | topics: {} ", topics.toArray());
        if(topics != null){
    ...
    private HttpStatus getSchemaRegistryStatus(){
        LOG.info("KafkaAdminClient | getSchemaRegistryStatus | method init");
        try {
            return webClient
    ...
    private boolean isTopicCreated(Collection<TopicListing> topics, String topicName) {
        LOG.info("KafkaAdminClient | isTopicCreated | topics: {}, topicName: ",
                topics, topicName);
        if(topics == null) {
            return false;
        }
